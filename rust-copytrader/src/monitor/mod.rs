...
fn journal_line(now_ms: u64, event: &MonEvent) -> String {
    match event {
        ...
        MonEvent::RiskSnapshot {
            ...
            "{{\"ts\":{},\"k\":\"risk_snapshot\",\"equity_usdc\":{},\"cash_usdc\":{},\"deployed_usdc\":{},\"gross_usdc\":{},\"net_usdc\":{},\"tail_24h_usdc\":{},\"tail_72h_usdc\":{},\"neg_risk_usdc\":{},\"tracking_err_bps\":{},\"hhi_bps\":{},\"follow_ratio_bps\":{}}}",
            now_ms,
            equity_usdc,
            cash_usdc,
            deployed_usdc,
