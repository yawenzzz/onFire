...
from polymarket_arb.service.status_daemon import start_status_daemon


class StatusDaemonTests(unittest.TestCase):
    def test_status_daemon_starts_server(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            daemon = start_status_daemon(root, host='127.0.0.1', port=0)
            try:
